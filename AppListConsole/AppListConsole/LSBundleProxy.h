...
@interface LSBundleProxy : NSObject <NSSecureCoding> {
    BOOL  _UPPValidated;
    id  __entitlements;
    id  __environmentVariables;
    id  __groupContainers;
    id  __infoDictionary;
...
@property (setter=_setEntitlements:, nonatomic, copy) id _entitlements;
@property (setter=_setEnvironmentVariables:, nonatomic, copy) id _environmentVariables;
@property (setter=_setGroupContainers:, nonatomic, copy) id _groupContainers;
